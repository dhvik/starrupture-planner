...
> = ({
  ...
  const options =
    useSubscription<PlannerRecipeOptionsItem[]>([optionsSubId]) ??
    EMPTY_RECIPE_OPTIONS;
  const itemsById =
    useSubscription<Record<string, Item>>([SUB_IDS.ITEMS_BY_ID_MAP]) ??
    EMPTY_ITEMS_BY_ID;
            ...
            >
              <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3">
                <div
                  ...
                  title={`Selected building: ${selectedOption.buildingName}`}
                >
