export const EVENT_IDS = {
  ...
  BASES_LAYOUT_MOVE_BUILDINGS: "basesLayoutMoveBuildings",
  ...
  BASES_LAYOUT_SET_POINTER_MODE: "basesLayoutSetPointerMode",
  BASES_LAYOUT_SET_CONNECTOR_MODE: "basesLayoutSetConnectorMode",
  BASES_LAYOUT_SET_TRANSFER_MODE: "basesLayoutSetTransferMode",
  BASES_LAYOUT_SET_SELECTED_RAIL_TIER: "basesLayoutSetSelectedRailTier",
  BASES_LAYOUT_SET_SELECTION: "basesLayoutSetSelection",
  BASES_LAYOUT_SET_SELECTED_BUILDING: "basesLayoutSetSelectedBuilding",
  BASES_LAYOUT_DELETE_SELECTED_BUILDING: "basesLayoutDeleteSelectedBuilding",
  BASES_LAYOUT_SET_SELECTED_CONNECTION: "basesLayoutSetSelectedConnection",
  BASES_LAYOUT_DELETE_SELECTED_CONNECTION:
    "basesLayoutDeleteSelectedConnection",
  BASES_LAYOUT_SET_ITEM_PALETTE_MODE: "basesLayoutSetItemPaletteMode",
  BASES_LAYOUT_TOGGLE_BUILDING_MODE: "basesLayoutToggleBuildingMode",
  BASES_LAYOUT_TOGGLE_BUILDING_ENABLED: "basesLayoutToggleBuildingEnabled",
  BASES_LAYOUT_SET_ALL_BUILDINGS_MODE: "basesLayoutSetAllBuildingsMode",
  ...
  PRODUCTION_PLAN_MODAL_SET_SELECTED_CORPORATION_LEVEL:
    "productionPlanModalSetSelectedCorporationLevel",
  PRODUCTION_PLAN_MODAL_SET_RECIPE_SELECTION:
    "productionPlanModalSetRecipeSelection",
