...
import { createRecipeSelectionKey } from "../../../utils/recipeSelection";
...
describe("buildProductionFlow", () => {
  ...
  describe("Alternative Recipe Selection", () => {
      ...
      const result = buildProductionFlow(
        {
          ...
          targetAmount: 60,
          recipeSelections: {
            rotor: createRecipeSelectionKey("craftertier2", "rotor"),
          },
        },
        altBuildings,
      );
    ...
    it("accepts legacy index-based selection keys as a fallback", () => {
      const result = buildProductionFlow(
        {
          targetItemId: "rotor",
          targetAmount: 60,
      ...
      expect(slowNode).toBeUndefined();
      expect(fastNode).toBeDefined();
      expect(fastNode!.buildingCount).toBe(1);
    });
      ...
      const selectedFlow = buildProductionFlow(
        {
          ...
          targetAmount: 60,
          recipeSelections: {
            bar_titanium: createRecipeSelectionKey(
              "blast_furnace",
              "bar_titanium",
            ),
          },
