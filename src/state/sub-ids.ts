export const SUB_IDS = {
  ...
  BASES_LAYOUT_POINTER_MODE: "baseLayoutPointerMode",
  BASES_LAYOUT_CONNECTOR_MODE: "baseLayoutConnectorMode",
  BASES_LAYOUT_TRANSFER_MODE: "baseLayoutTransferMode",
  BASES_LAYOUT_VIRTUAL_EDGES_FOR_SELECTION:
    "basesLayoutVirtualEdgesForSelection",
  BASES_LAYOUT_SELECTED_RAIL_TIER: "baseLayoutSelectedRailTier",
  BASES_LAYOUT_SELECTED_BUILDING_IDS: "baseLayoutSelectedBuildingIds",
  BASES_LAYOUT_SELECTED_BUILDING_ID: "baseLayoutSelectedBuildingId",
  BASES_LAYOUT_SELECTED_CONNECTION_IDS: "baseLayoutSelectedConnectionIds",
  ...
  PRODUCTION_PLAN_SECTION_VIEW_MODEL_BY_ID:
    "productionPlanSectionViewModelById",
  PRODUCTION_PLAN_SECTION_ITEM_NAME_BY_ITEM_ID:
    "productionPlanSectionItemNameByItemId",
  PRODUCTION_PLAN_SECTION_REQUIREMENTS_STATUS_BY_ID:
    "productionPlanSectionRequirementsStatusById",
  ...
  PRODUCTION_PLAN_MODAL_AVAILABLE_CORPORATION_LEVELS:
    "productionPlanModalAvailableCorporationLevels",
