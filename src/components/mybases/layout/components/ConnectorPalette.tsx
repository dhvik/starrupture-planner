...
const railTierInfo: Array<{ tier: RailTier; name: string; capacity: number; color: string }> = [
  { tier: 1, name: 'Tier 1 Rail', capacity: 120, color: 'bg-blue-500/20 hover:bg-blue-500/30 border-blue-500' },
  { tier: 2, name: 'Tier 2 Rail', capacity: 240, color: 'bg-green-500/20 hover:bg-green-500/30 border-green-500' },
  { tier: 3, name: 'Tier 3 Rail', capacity: 480, color: 'bg-purple-500/20 hover:bg-purple-500/30 border-purple-500' },
];
...
const ConnectorPalette = ({ className }: ConnectorPaletteProps) => {
  ...
  return (
    <div className={`flex flex-col ${className}`}>
      {/* Header */}
      <div className={`p-4 border-b border-base-300 flex-shrink-0 transition-colors ${
      ...
      <div className="p-4 space-y-2">
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <div className="text-xs text-base-content/70">Place & move buildings</div>
          </div>
          {!connectorMode && (
            <div className="badge badge-primary badge-sm font-bold">🖱️ ACTIVE</div>
          )}
        </button>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <div className="text-xs text-base-content/70">{capacity}/min capacity</div>
              </div>
              {isActive && (
                <div className="badge badge-primary badge-sm font-bold">🔗 ACTIVE</div>
              )}
            </button>
          );
        })}
        ...
        <div className="p-4 bg-primary/10 border-t border-primary/30">
          <div className="text-xs space-y-2">
            ...
            <ol className="list-decimal list-inside space-y-1 text-base-content/70">
              <li>Click on the <strong>source</strong> building (will be highlighted)</li>
              <li>Click on the <strong>target</strong> building to complete connection</li>
